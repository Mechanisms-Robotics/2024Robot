...
public class Arm extends SingleJointSubystem {
    ...
    private static final double kLeftMagnetOffset = kIdealStartRotation - 0.478027;
    // right arm motor magnet offset
    private static final double kRightMagnetOffset = kIdealStartRotation - 0.449219;
    ...
    private static final Rotation2d kIntaking = Rotation2d.fromDegrees(4.5);
