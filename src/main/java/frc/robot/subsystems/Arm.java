...
public class Arm extends SingleJointSubystem {
    ...
    private final TalonFX armMotor = new TalonFX(13, new CANCoder(12, kMagnetOffset));
    // left arm TalonFX motor
    private final TalonFX armFollower = new TalonFX(12);
    private static final ArmFeedforward kArmFeedForward = new ArmFeedforward(0, 0, 0, 0);
    ...
    private static final Rotation2d kStowed = Rotation2d.fromDegrees(0);
    private static final Rotation2d kIntaking = Rotation2d.fromDegrees(0);
    private static final Rotation2d kShooting = Rotation2d.fromDegrees(0);
    private static final double kMotorRatio = 1;
    private static final double kSensorRatio = 1;
    private static final Rotation2d kForwardLimit = Rotation2d.fromDegrees(0);
    private static final Rotation2d kReverseLimit = Rotation2d.fromDegrees(0);
